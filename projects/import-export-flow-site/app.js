...
const stages = [
  ...
  { id: "originPort", x: 538, y: 108, label: "top", icon: "crane", title: "Origin Port", short: "Origin Port", sub: "Terminal", parties: ["Terminal", "Carrier", "NVOCC"], documents: ["VGM", "Gate-in slip", "SI"], charges: ["Origin THC", "Port dues", "B/L fee"], watch: "Gate cut-off, VGM cut-off, SI cut-off, terminal congestion, and roll-over risk." },
